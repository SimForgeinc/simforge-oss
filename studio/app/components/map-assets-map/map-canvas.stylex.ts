...
export const styles = stylex.create({
  ...
  loadingPill: {
    ...
    zIndex: layers.raised,
    padding: "0.3rem 0.75rem",
    backgroundColor: `${colors.accentText}e0`,
    color: MUTED,
    fontSize: text.sizeXs,
    fontFamily: FONT,
    pointerEvents: "none",
  ...
  featurePrimary: { fontSize: text.sizeXs, fontWeight: text.weightSemibold, lineHeight: 1.35 },
  featureList: {
    listStyle: "none",
    margin: "0.35rem 0 0",
    padding: 0,
  ...
  popoverHeading: { marginBottom: space.s2, color: MUTED, fontWeight: text.weightMedium },
  popoverList: { listStyle: "none", margin: 0, padding: 0 },
  popoverItem: { marginBottom: space.s1 },
  popoverAsset: {
    display: "block",
    width: "100%",
    textAlign: "left",
