...
export const styles = stylex.create({
  ...
  brand: { display: { default: "none", [layout.bpLg]: "inline" }, flexShrink: 0, fontSize: text.sizeXl, fontFamily: text.fontHeavy, fontWeight: 700, letterSpacing: "-0.055em" },
  ...
  menuHeading: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: space.s2, fontSize: text.sizeSm, fontWeight: 600 },
