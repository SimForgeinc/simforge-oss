...
import { colors, layers, layout, motion, space, text } from "@simforge-oss/studio-ui/stylex/tokens.stylex";
...
export const styles = stylex.create({
  ...
  brand: { display: { default: "none", [layout.bpLg]: "inline" }, flexShrink: 0, fontSize: text.sizeXl, fontFamily: text.fontHeavy, fontWeight: text.weightBold, letterSpacing: text.trackingTight },
  ...
  context: { display: { default: "none", [layout.bpLg]: "inline" }, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", color: colors.inkMuted, fontSize: text.sizeSm },
  ...
  menu: { position: "fixed", zIndex: layers.appSwitcherTop, top: "4rem", right: layout.gutterNarrow, width: "min(28rem, calc(100vw - 32px))", maxHeight: "calc(100dvh - 5rem)", overflowY: "auto", border: `1px solid ${colors.hairline}`, backgroundColor: colors.card, color: colors.text, padding: space.s4 },
