/**
 * The request gate for this host (a slot: see host-slots.json). `proxy.ts`
 * at the app root re-exports it; the matcher stays there because Next reads
 * it statically. A host whose gate covers fewer paths returns
 * `NextResponse.next()` for the rest.
 */
