...
export const styles = stylex.create({
  ...
  selected: { backgroundColor: "hsl(var(--card) / .35)", padding: space.s4 },
  iconSmall: { width: "0.75rem", height: "0.75rem" },
  sidebarHeader: { flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "space-between", borderBottomWidth: stroke.hairline, borderBottomStyle: "solid", borderBottomColor: colors.hairline, paddingInline: space.s4, paddingBlock: space.s3 },
  ...
  datasetEmpty: { backgroundColor: colors.scrim, padding: space.s4, fontSize: text.sizeSm, lineHeight: text.lineSm, color: colors.inkMuted },
  datasetList: { minWidth: 0, display: "grid", gap: space.s2 },
  datasetButton: { minWidth: 0, display: "flex", width: "100%", gap: space.s3, paddingInline: space.s3, paddingBlock: space.s3, textAlign: "left", backgroundColor: colors.scrim, transitionProperty: "background-color, border-color", transitionDuration: motion.durStandard, ":hover": { borderColor: colors.hairlineStrong, backgroundColor: "rgba(10,10,12,1)" } },
  datasetActive: { borderColor: colors.accentLine, backgroundColor: colors.accentWash },
  ...
  datasetId: { overflowWrap: "anywhere", display: "block", marginTop: space.s1, color: colors.inkFaint },
  ...
  emptyState: { minHeight: "360px", backgroundColor: "hsl(var(--card) / .3)" },
  workspaceButton: { display: "inline-flex", height: "2.25rem", alignItems: "center", gap: space.s2, backgroundColor: colors.bg, paddingInline: space.s3, fontSize: text.sizeSm, lineHeight: text.lineSm, fontWeight: text.weightMedium, color: colors.text, transitionProperty: "background-color", transitionDuration: motion.durStandard, ":hover": { backgroundColor: colors.fillSubtle }, ":disabled": { cursor: "not-allowed", opacity: 0.45 } },
