...
import { colors, layers, motion, space, stroke } from "@simforge-oss/studio-ui/stylex/tokens.stylex";

export const gallery = stylex.create({
  toolbar: { position: "sticky", top: 0, zIndex: layers.sticky, borderBottomWidth: stroke.hairline, borderBottomStyle: "solid", borderBottomColor: colors.hairline, backgroundColor: colors.bg },
  ...
  emptyState: { borderWidth: stroke.hairline, borderStyle: "dashed", borderColor: colors.hairline },
