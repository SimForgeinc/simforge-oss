...
export const dialog = stylex.create({
  ...
  content: { position: "fixed", left: "50%", top: "50%", zIndex: layers.dialogTop, width: "min(760px, calc(100vw - 2rem))", maxHeight: "92vh", transform: "translate(-50%, -50%)", overflowY: "auto", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", borderRadius: "1rem", backgroundColor: "#0d1014", padding: space.s6, color: colors.ink, boxShadow: "0 25px 50px -12px rgba(0,0,0,0.5)", outlineWidth: stroke.thick, outlineStyle: "solid", outlineColor: "transparent", outlineOffset: "2px" },
  ...
  close: { position: "absolute", right: "1rem", top: "1rem", borderRadius: "0.375rem", padding: space.s2, color: colors.inkMuted, ":hover": { backgroundColor: "rgba(255,255,255,0.05)", color: colors.ink }, ":disabled": { opacity: 0.4 } },
  ...
  progress: { height: "0.375rem", overflow: "hidden", borderRadius: "9999px", backgroundColor: colors.glassRaised },
  ...
  drop: { display: "flex", minHeight: "8rem", width: "100%", flexDirection: "column", alignItems: "center", justifyContent: "center", borderWidth: stroke.hairline, borderStyle: "dashed", borderColor: "rgba(255,255,255,0.15)", borderRadius: "0.75rem", backgroundColor: SURFACE, paddingInline: space.s6, textAlign: "center", transitionProperty: "border-color, background-color", transitionDuration: motion.durStandard, ":hover": { borderColor: "rgba(232,224,68,0.4)", backgroundColor: "rgba(232,224,68,0.03)" } },
  ...
  card: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", borderRadius: "0.75rem", backgroundColor: SURFACE, padding: space.s4 },
  tabGroup: { marginTop: space.s5, display: "flex", width: "fit-content", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", borderRadius: "0.375rem", backgroundColor: SURFACE, padding: space.s1 },
  tab: { display: "flex", alignItems: "center", gap: space.s1_5, borderRadius: "0.25rem", paddingInline: space.s4, paddingBlock: space.s1_5, fontSize: text.sizeXs, lineHeight: text.lineXs, color: "rgba(255,255,255,0.4)", ":hover": { color: colors.ink }, ":disabled": { opacity: 0.4 } },
  tabActive: { backgroundColor: colors.fillStrong, color: colors.ink },
  stat: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.07)", borderRadius: "0.5rem", backgroundColor: "rgba(255,255,255,0.03)", padding: space.s3 },
  ...
  drawerPreviewLoading: { display: "grid", height: "18rem", placeItems: "center", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: colors.border, borderRadius: "0.75rem", backgroundColor: colors.card, fontSize: text.sizeXs, lineHeight: text.lineXs, color: colors.mutedForeground },
  ...
  tag: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: colors.border, borderRadius: "9999px", paddingInline: space.s2_5, paddingBlock: space.s1, fontSize: text.sizeXs, lineHeight: text.lineXs, color: colors.mutedForeground },
  ...
  clipList: { marginTop: space.s2, display: "flex", flexDirection: "column", gap: space.s1, borderWidth: stroke.hairline, borderStyle: "solid", borderColor: colors.border, borderRadius: "0.5rem", padding: space.s3, fontSize: text.sizeSm, lineHeight: text.lineSm },
  ...
  layerList: { marginTop: space.s2, borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.07)", borderRadius: "0.5rem" },
  ...
  drawerMono: { wordBreak: "break-all", borderRadius: "0.5rem", backgroundColor: "hsl(var(--muted) / 0.4)", paddingInline: space.s3, paddingBlock: space.s2, fontFamily: text.fontMono, fontSize: text.sizeXs, lineHeight: text.lineXs, color: colors.mutedForeground },
  uploadMono: { marginTop: space.s1, wordBreak: "break-all", borderRadius: "0.5rem", backgroundColor: "rgba(0,0,0,0.3)", paddingInline: space.s3, paddingBlock: space.s2, fontFamily: text.fontMono, color: "rgba(255,255,255,0.6)" },
  ...
  preview: { aspectRatio: "1", width: "100%", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", borderRadius: "0.75rem", backgroundImage: "radial-gradient(circle,#27303a,#101317)", objectFit: "contain" },
  ...
  recent: { marginTop: space.s5, borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(232,224,68,0.2)", borderRadius: "0.75rem", backgroundColor: "rgba(232,224,68,0.04)", padding: space.s4 },
  recentList: { marginTop: space.s2, display: "flex", flexDirection: "column", gap: space.s2 },
  recentItem: { display: "flex", width: "100%", alignItems: "center", justifyContent: "space-between", borderRadius: "0.5rem", backgroundColor: colors.fillSubtle, paddingInline: space.s3, paddingBlock: space.s2, textAlign: "left", fontSize: text.sizeSm, lineHeight: text.lineSm, ":hover": { backgroundColor: colors.glassRaised } },
  ...
  cardSuccess: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(52,211,153,0.2)", borderRadius: "0.75rem", backgroundColor: "rgba(52,211,153,0.06)", padding: space.s4 },
  cardWarning: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(252,211,77,0.25)", borderRadius: "0.75rem", backgroundColor: "rgba(252,211,77,0.05)", padding: space.s4 },
  ...
  clearButton: { position: "absolute", right: "0.5rem", top: "50%", display: "grid", width: "1.5rem", height: "1.5rem", placeItems: "center", transform: "translateY(-50%)", borderRadius: "0.25rem", color: colors.mutedForeground, transitionProperty: "color", transitionDuration: motion.durStandard, transitionTimingFunction: motion.easeStandard, ":hover": { color: colors.text }, ":focus-visible": { outlineWidth: stroke.thick, outlineStyle: "solid", outlineColor: "transparent", outlineOffset: "2px", boxShadow: shadows.ring } },
  ...
  generateCard: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(232,224,68,0.2)", borderRadius: "0.75rem", backgroundColor: "rgba(232,224,68,0.03)", padding: space.s4 },
  ...
  artifactDot: { marginTop: space.s2, width: "0.25rem", height: "0.25rem", flexShrink: 0, borderRadius: "9999px", backgroundColor: "rgba(232,224,68,0.6)" },
  ...
  deleteBox: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "hsl(var(--destructive) / 0.5)", borderRadius: "0.5rem", backgroundColor: "hsl(var(--destructive) / 0.1)", padding: space.s3 },
  ...
  usageWarning: { marginTop: space.s2, display: "inline-flex", alignItems: "center", gap: space.s2, borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "hsl(var(--primary) / 0.4)", borderRadius: "0.375rem", backgroundColor: "hsl(var(--primary) / 0.1)", paddingInline: space.s2_5, paddingBlock: space.s1_5, fontSize: text.sizeSm, lineHeight: text.lineSm, fontWeight: text.weightSemibold, color: colors.primary },
  ...
  uploadBar: { height: "0.375rem", overflow: "hidden", borderRadius: "9999px", backgroundColor: colors.glassRaised },
  ...
  uploadImage: { aspectRatio: "1", width: "100%", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", borderRadius: "0.75rem", backgroundImage: "radial-gradient(circle,#27303a,#101317)", objectFit: "contain" },
  ...
  motionOption: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.12)", borderRadius: "0.5rem", backgroundColor: "rgba(255,255,255,0.03)", padding: space.s3, textAlign: "left", ":hover": { backgroundColor: colors.fill } },
...
export const drawer = stylex.create({
  ...
  tile: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: colors.border, borderRadius: "0.5rem", backgroundColor: "hsl(var(--muted) / 0.3)", padding: space.s3 },
