...
export const gallery = stylex.create({
  ...
  toolbar: { position: "sticky", top: 0, zIndex: 20, borderBottom: `1px solid ${colors.border}`, backgroundColor: "hsl(var(--background) / 0.85)", paddingInline: "1.25rem", backdropFilter: "blur(8px)", [SM]: { paddingInline: "2rem" } },
  main: { paddingInline: "1.25rem", paddingBlock: "1.5rem", [SM]: { paddingInline: "2rem" } },
  measure: { width: "100%", maxWidth: "1500px", marginInline: "auto" },
  alert: { marginBottom: "1rem", border: "1px solid rgba(248,113,113,0.2)", borderRadius: "0.5rem", backgroundColor: "rgba(248,113,113,0.05)", paddingInline: "1rem", paddingBlock: "0.75rem", fontSize: text.sizeSm, color: "#fecaca" },
...
export const fallback = stylex.create({
  chrome: { borderBottom: `1px solid ${colors.border}`, backgroundColor: colors.bg, paddingInline: "1.25rem", [SM]: { paddingInline: "2rem" } },
  measure: { width: "100%", maxWidth: "1500px", marginInline: "auto", paddingBlock: "1.25rem" },
  title: { marginTop: "0.625rem" },
  description: { marginTop: "0.75rem", width: "100%", maxWidth: "36rem" },
  button: { marginTop: "1.25rem", borderRadius: "0.375rem" },
...
export const maps = stylex.create({
  ...
  error: { border: "1px solid rgba(248,113,113,0.2)", borderRadius: "0.5rem", backgroundColor: "rgba(248,113,113,0.05)", paddingInline: "1rem", paddingBlock: "0.75rem", fontSize: text.sizeSm, color: "#fecaca" },
  empty: { display: "grid", minHeight: "20rem", placeItems: "center", border: "1px dashed rgba(255,255,255,0.1)", borderRadius: "0.75rem", paddingInline: "1.5rem", textAlign: "center" },
  emptyInner: { width: "100%", maxWidth: "28rem" },
  emptyIcon: { marginInline: "auto", width: "2rem", height: "2rem", color: "rgba(255,255,255,0.2)" },
  emptyText: { marginTop: "0.75rem", fontSize: text.sizeSm, color: "rgba(255,255,255,0.55)" },
  emptyHint: { marginTop: "0.25rem", fontSize: text.sizeXs, color: "rgba(255,255,255,0.35)" },
  upload: { marginTop: "1.25rem", backgroundColor: ACCENT, color: "#000", ":hover": { backgroundColor: "#f3ec62" } },
  card: { [MAP_ZOOM]: { default: "none", ":hover": "scale(1.025)" }, overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "0.75rem", backgroundColor: SURFACE, transitionProperty: "border-color, background-color", transitionDuration: "150ms", transitionTimingFunction: EASE, ":hover": { borderColor: "rgba(255,255,255,0.2)", backgroundColor: "rgba(255,255,255,0.045)" } },
  well: { position: "relative", aspectRatio: "4 / 3", overflow: "hidden", background: "radial-gradient(circle at 50% 42%, #29313a, #101317 68%)" },
  ...
  body: { padding: "1rem" },
  name: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: text.sizeSm, fontWeight: 600 },
  locality: { marginTop: "0.5rem", display: "flex", alignItems: "center", gap: "0.375rem", overflow: "hidden", fontSize: text.sizeXs, color: "rgba(255,255,255,0.35)" },
...
export const preview = stylex.create({
  root: { position: "relative", height: "18rem", overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "0.75rem", backgroundColor: "#101317" },
  host: { position: "absolute", inset: 0 },
  loading: { pointerEvents: "none", position: "absolute", inset: 0, display: "grid", placeItems: "center", fontSize: text.sizeXs, color: "rgba(255,255,255,0.35)" },
  error: { position: "absolute", inset: 0, display: "grid", placeItems: "center", paddingInline: "2rem", textAlign: "center", fontSize: text.sizeSm, color: "#fca5a5" },
});

export const picker = stylex.create({
  root: { display: "flex", flexDirection: "column", gap: "0.75rem" },
  input: { position: "absolute", width: "1px", height: "1px", padding: 0, margin: "-1px", overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", border: 0 },
  drop: { display: "flex", minHeight: "7rem", width: "100%", flexDirection: "column", alignItems: "center", justifyContent: "center", border: "1px dashed rgba(255,255,255,0.15)", borderRadius: "0.75rem", backgroundColor: SURFACE, paddingInline: "1.5rem", textAlign: "center", transitionProperty: "border-color, background-color", transitionDuration: "150ms", transitionTimingFunction: EASE, ":hover": { borderColor: "rgba(232,224,68,0.4)", backgroundColor: "rgba(232,224,68,0.03)" }, ":focus-visible": { outline: "none", boxShadow: `0 0 0 2px ${ACCENT}` }, ":disabled": { cursor: "not-allowed", opacity: 0.45 } },
  addIcon: { marginBottom: "0.5rem", width: "1.5rem", height: "1.5rem", color: ACCENT },
  label: { fontSize: text.sizeSm, fontWeight: 500 },
  hint: { marginTop: "0.25rem", fontSize: text.sizeXs, color: "rgba(255,255,255,0.35)" },
  images: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "0.75rem", [SM]: { gridTemplateColumns: "repeat(4, minmax(0, 1fr))" } },
  image: { position: "relative", overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "0.75rem", backgroundColor: "rgba(255,255,255,0.03)" },
