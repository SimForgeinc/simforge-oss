...
export const maps = stylex.create({
  ...
  error: { borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(248,113,113,0.2)", backgroundColor: "rgba(248,113,113,0.05)", paddingInline: space.s4, paddingBlock: space.s3, fontSize: text.sizeSm, lineHeight: text.lineSm, color: "#fecaca" },
  empty: { display: "grid", minHeight: "20rem", placeItems: "center", borderWidth: stroke.hairline, borderStyle: "dashed", borderColor: "rgba(255,255,255,0.1)", paddingInline: space.s6, textAlign: "center" },
  // The loading box is the same frame without `px-6`.
  emptyFlush: { display: "grid", minHeight: "20rem", placeItems: "center", borderWidth: stroke.hairline, borderStyle: "dashed", borderColor: "rgba(255,255,255,0.1)", textAlign: "center" },
  ...
  card: { [MAP_ZOOM]: { default: "none", ":hover": "scale(1.025)" }, overflow: "hidden", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: colors.hairline, backgroundColor: SURFACE, transitionProperty: "border-color, background-color", transitionDuration: motion.durStandard, transitionTimingFunction: motion.easeStandard, ":hover": { borderColor: "rgba(255,255,255,0.2)", backgroundColor: "rgba(255,255,255,0.045)" } },
  ...
  id: { marginTop: space.s3, fontFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace", fontSize: "10px", color: "rgba(255,255,255,0.3)" },
...
export const preview = stylex.create({
  root: { position: "relative", height: "18rem", overflow: "hidden", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", backgroundColor: "#101317" },
...
export const picker = stylex.create({
  ...
  drop: { display: "flex", minHeight: "7rem", width: "100%", flexDirection: "column", alignItems: "center", justifyContent: "center", borderWidth: stroke.hairline, borderStyle: "dashed", borderColor: "rgba(255,255,255,0.15)", backgroundColor: SURFACE, paddingInline: space.s6, textAlign: "center", transitionProperty: "border-color, background-color", transitionDuration: motion.durStandard, transitionTimingFunction: motion.easeStandard, ":hover": { borderColor: "rgba(232,224,68,0.4)", backgroundColor: "rgba(232,224,68,0.03)" }, ":disabled": { cursor: "not-allowed", opacity: 0.45 } },
  ...
  image: { position: "relative", overflow: "hidden", borderWidth: stroke.hairline, borderStyle: "solid", borderColor: "rgba(255,255,255,0.1)", backgroundColor: "rgba(255,255,255,0.03)" },
  imagePreview: { aspectRatio: "1", width: "100%", objectFit: "cover" },
  front: { position: "absolute", left: "0.5rem", top: "0.5rem", backgroundColor: colors.accent, paddingInline: space.s2, paddingBlock: space.s0_5, fontSize: "10px", fontWeight: text.weightSemibold, textTransform: "uppercase", letterSpacing: text.trackingWide, color: "#000" },
  remove: { position: "absolute", right: "0.375rem", top: "0.375rem", backgroundColor: "rgba(0,0,0,0.7)", padding: space.s1, color: colors.inkSecondary, ":hover": { color: colors.ink } },
  ...
  move: { padding: space.s1, color: "rgba(255,255,255,0.55)", ":hover": { backgroundColor: colors.fillStrong, color: colors.ink }, ":disabled": { opacity: 0.2 } },
  view: { minWidth: 0, fontSize: "10px", color: colors.inkMuted },
