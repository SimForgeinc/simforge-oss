...
export const styles = stylex.create({
  ...
  u_900: { backdropFilter: "blur(12px)" },
  u_901: { backgroundColor: "hsl(var(--muted/20))" },
  u_902: { display: "block" },
  u_903: { borderWidth: "1px", borderStyle: "solid" },
  u_904: { borderBottomWidth: "1px", borderBottomStyle: "solid" },
  u_905: { borderColor: "hsl(var(--border))" },
  u_906: { cursor: "pointer" },
  u_907: { transitionDuration: "150ms" },
  u_908: { display: "flex" },
  u_909: { flexWrap: "wrap" },
  u_910: { ':focus-visible': { outlineStyle: "none" } },
  u_911: { ':focus-visible': { outlineWidth: "2px" } },
  u_912: { ':focus-visible': { outlineColor: "#E8E044" } },
  u_916: { gap: "0.25rem" },
  u_917: { gap: "0.375rem" },
  u_918: { gap: "0.5rem" },
  u_919: { gap: "0.625rem" },
  u_920: { columnGap: "0.75rem" },
  u_921: { rowGap: "0.25rem" },
  u_922: { height: "2.5rem" },
  u_923: { backgroundColor: "hsl(var(--muted) / 0.5)" },
  u_924: { backgroundColor: "hsl(var(--secondary) / 0.4)" },
  u_925: { ':hover': { transform: "scale(1.1)" } },
  u_926: { ':hover': { color: "hsl(var(--foreground))" } },
  u_927: { display: "inline-flex" },
  u_928: { alignItems: "center" },
  u_929: { justifyContent: "center" },
  u_930: { lineHeight: 1.625 },
  u_931: { marginLeft: "0.125rem" },
  u_932: { marginRight: "0.5rem" },
  u_933: { padding: "0.25rem" },
  u_934: { paddingInline: "0.25rem" },
  u_935: { paddingInline: "0.375rem" },
  u_936: { paddingInline: "0.5rem" },
  u_937: { paddingInline: "0.625rem" },
  u_938: { paddingInline: "0.75rem" },
  u_939: { paddingInline: "0.875rem" },
  u_940: { paddingInline: "1rem" },
  u_941: { paddingBlock: "0.125rem" },
  u_942: { paddingBlock: "0.25rem" },
  u_943: { paddingBlock: "0.375rem" },
  u_944: { paddingBlock: "0.5rem" },
  u_945: { paddingBlock: "0.625rem" },
  u_946: { paddingBlock: "0.75rem" },
  u_947: { paddingBlock: "1px" },
  u_948: { boxShadow: "0 0 0 1px currentColor" },
  u_949: { boxShadow: "0 0 0 1px rgb(0 0 0 / 20%)" },
  u_950: { boxShadow: "inset 0 0 0 1px currentColor" },
  u_951: { borderRadius: "0.25rem" },
  u_952: { borderRadius: "9999px" },
  u_953: { borderRadius: "0.5rem" },
  u_954: { borderRadius: "0.375rem" },
  u_955: { borderRadius: "0.125rem" },
  u_960: { width: "1.25rem", height: "1.25rem" },
  u_961: { fontVariantNumeric: "tabular-nums" },
  u_962: { fontSize: "10px" },
  u_963: { fontSize: "11px" },
  u_964: { color: "hsl(var(--foreground))" },
  u_965: { textAlign: "left" },
  u_969: { transitionProperty: "all" },
  u_970: { transitionProperty: "color" },
  u_971: { transitionProperty: "transform" },
});
