...
export const styles = stylex.create({
  ...
  s_235: {
    ...
    width: "100%",
    maxWidth: "1440px",
    paddingInline: { default: "1.25rem", "@media (min-width: 640px)": space.s8, "@media (min-width: 1024px)": space.datasetStripWidth },
    paddingBottom: { default: "1.25rem", "@media (min-width: 640px)": space.s8, "@media (min-width: 1024px)": "2.5rem" },
  },
  s_236: {
    maxWidth: "42rem",
  },
  ...
  s_248: {
    ...
    paddingTop: { default: space.s4, "@media (min-width: 640px)": "1.25rem" },
  },
  s_908: {
    display: "flex",
    alignItems: "center",
  ...
  s_250: {
    ...
    borderStyle: "solid",
    borderColor: { default: "rgba(255, 255, 255, 0.2)", ":hover": "rgba(232, 224, 68, 0.7)" },
    backgroundColor: { default: colors.scrimLight, ":hover": "rgba(232, 224, 68, 0.1)" },
  ...
  s_253: {
    ...
    paddingInline: { default: space.s4, "@media (min-width: 640px)": "1.25rem" },
    fontSize: text.sizeSm,
    lineHeight: "1.25rem",
    fontWeight: 600,
    color: "#000",
