...
export const styles = stylex.create({
  ...
  s_216: {
    ...
    color: { default: "rgba(255, 255, 255, 0.85)", ":hover": colors.ink },
  ...
  s_231: {
    ...
    backgroundColor: { default: colors.scrim, ":hover": "rgba(0, 0, 0, 0.65)" },
    paddingInline: space.s3_5,
    fontSize: text.sizeXs,
    lineHeight: text.lineXs,
    fontWeight: text.weightSemibold,
  ...
  s_237: {
    ...
    alignItems: "center",
    gap: space.s2,
    fontSize: { default: "10px", [layout.bpSm]: "11px" },
    fontWeight: text.weightSemibold,
  ...
  s_243: {
    ...
    columnGap: space.s4,
    rowGap: space.s1,
    fontSize: { default: "11px", [layout.bpSm]: text.sizeXs },
  ...
  s_245: {
    ...
    alignItems: "center",
    gap: space.s1,
    color: { default: "rgba(255, 255, 255, 0.58)", ":hover": colors.ink },
    transitionProperty: "color, background-color, border-color, text-decoration-color, fill, stroke",
    transitionTimingFunction: motion.easeStandard,
    transitionDuration: motion.durStandard,
  },
