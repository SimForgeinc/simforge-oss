 ...
 * - `luminaires`: `derived/luminaires/manifest.json`, the map's street
 *   luminaires, the night renderer's light fixtures (docs/engineering/map-luminaires.md)
 *
...
export interface MapDerivativeKind {
  ...
  key: "geometryLod" | "texturesFullBc7" | "roadDecals" | "textureDensity" | "luminaires" | "browserVariants" | "browserScene";
...
export const MAP_DERIVATIVES: readonly MapDerivativeKind[] = [
  ...
  { key: "luminaires", profile: "native", directory: "derived/luminaires", prefixes: ["derived/luminaires/"], schema: "simforge.map-luminaires.v1" },
