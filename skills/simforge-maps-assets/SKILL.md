...
| `--registry URL` |  | Registry base URL (https:// or file://). Default: SIMFORGE_MAPS_REGISTRY, SIMFORGE_MAPS_PUBLIC_URL, then the public registry. A private https registry reads a bearer token from SIMFORGE_MAPS_REGISTRY_TOKEN |
...
| Argument / flag | | What |
|---|---|---|
| `--closure SHA256` |  | The closure digest (sha256). Default: the closure this build is pinned to |
