...
- Map signals: `signal:feature:<featureId>:<approach>.phase` where `<featureId>` is
  ...
  green_arrow, yellow_arrow, red_x, flashing_yellow_arrow, flashing_red_arrow. Actor
  `"@world"`. This is how you make the light change mid-clip.
