...
// TODO: Transforming UVs mean we need to apply derivative chain rule for meshlet mesh material pass
    ...
    // Per-slot texture coordinates: every slot samples its own channel through
    // its own transform (glTF KHR_texture_transform is per slot). `uv`/`uv_b`
    // above keep the material-level transform for parallax and lightmaps.
#ifdef BINDLESS
    let slot_material = pbr_bindings::material_array[material_indices[slot].material];
#else   // BINDLESS
    let slot_material = pbr_bindings::material;
#endif  // BINDLESS
    var slot_uv_inputs: pbr_types::SlotUvInputs;
#ifdef VERTEX_UVS_A
    slot_uv_inputs.raw[0] = in.uv;
#else
    slot_uv_inputs.raw[0] = vec2<f32>(0.0);
#endif
#ifdef VERTEX_UVS_B
    slot_uv_inputs.raw[1] = in.uv_b;
#else
    slot_uv_inputs.raw[1] = slot_uv_inputs.raw[0];
#endif
#ifdef VERTEX_UVS_C
    slot_uv_inputs.raw[2] = in.uv_c;
#else
    slot_uv_inputs.raw[2] = slot_uv_inputs.raw[0];
#endif
#ifdef VERTEX_UVS_D
    slot_uv_inputs.raw[3] = in.uv_d;
#else
    slot_uv_inputs.raw[3] = slot_uv_inputs.raw[0];
#endif
    slot_uv_inputs.parallax_delta[0] = uv - (uv_transform * vec3(slot_uv_inputs.raw[0], 1.0)).xy;
    slot_uv_inputs.parallax_delta[1] = uv_b - (uv_transform * vec3(slot_uv_inputs.raw[1], 1.0)).xy;
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_BASE_COLOR, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                bias.ddx_uv,
                bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_SPECULAR, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_SPECULAR_TINT, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_EMISSIVE, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_METALLIC_ROUGHNESS, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_CLEARCOAT, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_CLEARCOAT_ROUGHNESS, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_SPECULAR_TRANSMISSION, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_THICKNESS, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_DIFFUSE_TRANSMISSION, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_OCCLUSION, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_NORMAL_MAP, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                bias.ddx_uv,
                bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif  // BINDLESS
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_CLEARCOAT_NORMAL, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                bias.ddx_uv,
                bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
...
#endif
                pbr_types::standard_material_slot_uv(slot_material, pbr_types::STANDARD_MATERIAL_SLOT_ANISOTROPY, slot_uv_inputs),
#ifdef MESHLET_MESH_MATERIAL_PASS
                    bias.ddx_uv,
                    bias.ddy_uv,
#else   // MESHLET_MESH_MATERIAL_PASS
