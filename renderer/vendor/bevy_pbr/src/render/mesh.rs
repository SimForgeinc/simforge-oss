...
impl SpecializedMeshPipeline for MeshPipeline {
    ...
    fn specialize(
        ...
        if layout.0.contains(Mesh::ATTRIBUTE_UV_2) {
            shader_defs.push("VERTEX_UVS".into());
            shader_defs.push("VERTEX_UVS_C".into());
            vertex_attributes.push(Mesh::ATTRIBUTE_UV_2.at_shader_location(8));
        }

        if layout.0.contains(Mesh::ATTRIBUTE_UV_3) {
            shader_defs.push("VERTEX_UVS".into());
            shader_defs.push("VERTEX_UVS_D".into());
            vertex_attributes.push(Mesh::ATTRIBUTE_UV_3.at_shader_location(9));
        }
