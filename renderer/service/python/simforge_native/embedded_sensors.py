"""Renderer-only sensors for external physics owners (MuJoCo body truth).
...
class ExternalSensorRig:
    """Renderer-only camera transport for a non-Episode physics owner.
    ...
    def __enter__(self) -> "ExternalSensorRig":
        return self
