...
impl SemanticClass {
    ...
    pub fn try_from_actor_class(actor_class: &str) -> Result<SemanticClass, String> {
        match actor_class {
            ...
            other => Err(format!(
                "[native_actor_class_unmapped] actor class {other:?} has no semantic class"
            )),
        }
    }
    ...
    pub fn from_mesh_name(name: &str) -> SemanticClass {
        match StaticKind::of(name) {
            ...
            | StaticKind::Fence
            | StaticKind::Unknown => SemanticClass::Prop,
        }
    }
}
...
mod tests {
    ...
    fn rider_is_its_own_class() {
        assert_eq!(
            SemanticClass::try_from_actor_class("rider"),
            Ok(SemanticClass::Rider)
        );
        // RoadRunner asset names (Belmont master).
        assert_eq!(
            super::StaticKind::of("SM_NorwayMaple_Field_02_PP"),
            super::StaticKind::Vegetation
        );
        assert_eq!(
            super::StaticKind::of("FencePost_6ft_Prop"),
            super::StaticKind::Fence
        );
        assert_eq!(
            super::StaticKind::of("signal_post_35ft_mesh_Prop"),
            super::StaticKind::Pole
        );
        assert_eq!(
            super::StaticKind::of("sign_post_10_mesh_Prop"),
            super::StaticKind::Pole
        );
        assert_eq!(
            super::StaticKind::of("Sign_R1-1_1_StopSign"),
            super::StaticKind::TrafficSign
        );
        assert_eq!(
            super::StaticKind::of("Luminaire_Head02_mesh_Prop"),
            super::StaticKind::Pole
        );
        assert_eq!(
            super::StaticKind::of("ParkingBlocks_Lg01_Prop"),
            super::StaticKind::Unknown
        );
        ...
        assert_ne!(
            SemanticClass::try_from_actor_class("cyclist"),
            Ok(SemanticClass::Rider)
        );
    }
}
