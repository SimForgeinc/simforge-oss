...
export const styles = stylex.create({
  ...
  row: { display: "grid", gap: space.s2, paddingBlock: space.s3, animationName: { default: pulse, "@media (prefers-reduced-motion: reduce)": "none" }, animationDuration: "1.5s", animationIterationCount: "infinite" },
