...
export const styles = stylex.create({
  ...
  detail: { marginTop: space.s2_5, fontSize: "1.0625rem", lineHeight: text.lineBase, color: colors.inkMuted },
  ...
  progressFill: { height: "100%", backgroundColor: colors.accent, transitionProperty: "width", transitionDuration: motion.durSlow, transitionTimingFunction: motion.easeOut },
  ...
  progressMeta: { marginTop: space.s2_5, display: "flex", justifyContent: "flex-end", color: colors.inkFaint },
  telemetry: { marginTop: space.s5, borderRadius: "0.75rem", borderWidth: stroke.hairline, paddingInline: space.s4, paddingBlock: space.s3, fontFamily: text.fontMono, fontSize: text.sizeXs, color: colors.inkSecondary, backgroundColor: "rgb(0 0 0 / 15%)", borderColor: colors.hairline },
  telemetryStalled: { borderColor: colors.warning, backgroundColor: colors.warningWash, color: colors.warning },
  ...
  telemLabel: { color: colors.inkMuted },
  telemValue: { margin: 0, fontSize: text.sizeXs, fontVariantNumeric: "tabular-nums", color: colors.ink, },
  telemText: { marginTop: space.s2, color: colors.inkMuted },
  telemWarn: { marginTop: space.s2, color: colors.warning },
