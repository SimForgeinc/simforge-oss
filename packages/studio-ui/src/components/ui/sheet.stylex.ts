...
export const styles = stylex.create({
  ...
  top: { insetInline: 0, top: 0, borderBottomWidth: stroke.hairline, borderBottomStyle: "solid", borderBottomColor: colors.hairline, animationName: { default: null, "[data-state=open]": slideTopIn, "[data-state=closed]": slideTopOut } },
  bottom: { insetInline: 0, bottom: 0, borderTopWidth: stroke.hairline, borderTopStyle: "solid", borderTopColor: colors.hairline, animationName: { default: null, "[data-state=open]": slideBottomIn, "[data-state=closed]": slideBottomOut } },
  left: { insetBlock: 0, left: 0, width: "75%", height: "100%", borderRightWidth: stroke.hairline, borderRightStyle: "solid", borderRightColor: colors.hairline, animationName: { default: null, "[data-state=open]": slideLeftIn, "[data-state=closed]": slideLeftOut }, "@media (min-width: 640px)": { maxWidth: "24rem" } },
  right: { insetBlock: 0, right: 0, width: "75%", height: "100%", borderLeftWidth: stroke.hairline, borderLeftStyle: "solid", borderLeftColor: colors.hairline, animationName: { default: null, "[data-state=open]": slideRightIn, "[data-state=closed]": slideRightOut }, "@media (min-width: 640px)": { maxWidth: "24rem" } },
  close: {
