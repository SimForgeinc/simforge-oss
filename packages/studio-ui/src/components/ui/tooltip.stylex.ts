...
import { colors, layers, motion, radii, space, stroke, text } from "../../stylex/tokens.stylex";
...
export const styles = stylex.create({
  content: {
    zIndex: layers.popover, overflow: "hidden", borderRadius: radii.md, borderWidth: stroke.hairline, borderStyle: "solid", borderColor: colors.border,
