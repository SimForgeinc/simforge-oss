...
export const art = stylex.create({
  basePath: { fill: "none", stroke: colors.inkMuted, strokeWidth: stroke.thick },
  ...
  legendBase: { display: "inline-block", width: "1.5rem", borderTopWidth: stroke.thick, borderTopStyle: "solid", borderTopColor: colors.inkMuted },
