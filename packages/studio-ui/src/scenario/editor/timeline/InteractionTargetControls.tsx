  ...
  return (
    <div className="space-y-2">
      ...
      {target.mode === "turn" ? (
        ...
        <FramePoseList interactionId={interaction.id} points={Array.isArray(target.points) ? target.points : []} onChange={(points) => onChange({ ...target, points })} />
      ) : target.mode === "customRoute" ? (
        <CustomPointList interactionId={interaction.id} points={Array.isArray(target.points) ? target.points : []} onChange={(points) => onChange({ ...target, points })} />
      ) : target.mode === "customTimedRoute" ? (
        <TimedCustomPointList interactionId={interaction.id} points={Array.isArray(target.points) ? target.points : []} onChange={(points) => onChange({ ...target, points })} />
