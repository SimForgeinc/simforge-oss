...
export const styles = stylex.create({
  ...
  lede: { fontSize: text.sizeSm, lineHeight: text.lineNormal, color: colors.inkMuted, },
  ...
  choice: {
    ...
    minWidth: 0, minHeight: "8rem", textAlign: "left", padding: space.s3, backgroundColor: colors.fillSubtle,
  ...
  choiceCurrent: { borderColor: colors.accent, backgroundColor: colors.accentWash },
  choiceLabel: { fontSize: text.sizeSm, lineHeight: text.lineTight, fontWeight: text.weightSemibold },
  choiceCopy: { fontSize: text.sizeXs, lineHeight: text.lineNormal, color: colors.inkMuted, minWidth: 0 },
  choiceTag: { fontFamily: text.fontMeta, fontSize: text.sizeXs, color: colors.accent },
  cache: { minWidth: 0, padding: space.s3, backgroundColor: colors.fillSubtle },
});
