...
export const SCENARIO_AUTHORING_QUALITY_CHOICES = [
  ...
  { id: "minimal", label: "Balanced", guidance: "Road and coarse city context only: no vegetation, low resolution, and very restrained streaming.", downloadGuidance: "Measured cold load: 45–534 MB", gpuMemoryGuidance: "Resident estimate: 370–640 MB · 2 GB GPU recommended", recommended: false },
  { id: "high", label: "High", guidance: "Sharper viewport with a larger resident scene.", downloadGuidance: "Measured cold load: 44–816 MB", gpuMemoryGuidance: "Resident estimate: 377–1,601 MB · 4 GB GPU recommended", recommended: true },
