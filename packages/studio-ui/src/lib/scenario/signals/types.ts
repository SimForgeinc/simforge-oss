...
export type EditorSignalHead = {
   ...
   * junction, never a movement. Here it is exact: the native signal control index
...
/** One diagnostic from the native signal control index, carried through the wire. */
